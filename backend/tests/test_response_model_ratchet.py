...
_HORS_SUJET: set[str] = {
    ...
    "phishing/campaigns.py::delete_campaign",
    "phishing/targets.py::delete_single_target",
    ...
    "pca.py::generate_pca",
    "phishing/report.py::download_report_pdf",
    "phishing/tracking.py::tracking_click",
    "phishing/tracking.py::tracking_landing",
    "phishing/tracking.py::tracking_pixel",
    "phishing/tracking.py::tracking_submit",
