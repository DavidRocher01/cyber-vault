...
async def test_submit_max_score():
    from app.api.v1.endpoints.quiz import submit_quiz, QuizSubmit, QuizAnswer
...
async def test_submit_partial_score():
    from app.api.v1.endpoints.quiz import submit_quiz, QuizSubmit, QuizAnswer, QUESTIONS
...
def test_level_advanced():
    from app.api.v1.endpoints.quiz import _compute_level, MAX_SCORE
...
async def test_submit_max_score_value():
    from app.api.v1.endpoints.quiz import submit_quiz, QuizSubmit, QuizAnswer, MAX_SCORE
    payload = QuizSubmit(answers=[QuizAnswer(**a) for a in _all_d_answers()])
    result = await submit_quiz(payload)
