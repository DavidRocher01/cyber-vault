...
class RssiVisit(Base):
    ...
    visit_type: Mapped[str] = mapped_column(String(30), nullable=False, default="monthly", server_default="monthly")
    # onsite | remote
    location: Mapped[str] = mapped_column(String(20), nullable=False, default="onsite", server_default="onsite")
