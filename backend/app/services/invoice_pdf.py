...
def generate_invoice_pdf(
    ...
    top_row = Table([[brand_box, "", facture_box]],
    ...
    info_row = Table([[vendor_info, "", ref_info]],
                     colWidths=[half, gap, half])
    ...
    client_row = Table([[vendor_label, "", client_box]],
                       colWidths=[half, gap, half])
    ...
    items = Table([
        [
            _p("Description", fontSize=8.5, fontName="Helvetica-Bold", textColor=BLACK),
            _p("Montant TTC",  fontSize=8.5, fontName="Helvetica-Bold", textColor=BLACK, alignment=2),
        ],
        [
            _p(description, fontSize=9, fontName="Helvetica", textColor=BLACK, leading=13),
            _p(_fmt(amount_cents), fontSize=9, fontName="Helvetica", textColor=BLACK, alignment=2),
        ],
    ...
    # ══════════════════════════════════════════════════════════════════════════
    notes_box = Table([[
        _p(f"Fait à Reyrieux, le {_date(issue_date)}",
           fontSize=8.5, fontName="Helvetica", textColor=BLACK),
    ], [
        _p("<b>Signature</b>",
           fontSize=8.5, fontName="Helvetica-Bold", textColor=BLACK),
    ], [
    ...
    totals_box = Table([
        ...
        [_p("Net à payer",        fontSize=10, fontName="Helvetica-Bold", textColor=NAVY),
         _p(f"<b>{_fmt(amount_cents)}</b>", fontSize=11, fontName="Helvetica-Bold",
            textColor=NAVY, alignment=2)],
    ...
    bottom_row = Table([[notes_box, "", totals_box]],
                       colWidths=[half, gap, half])
    ...
    s.append(_p(
        ...
        fontSize=6.5, fontName="Helvetica", textColor=GRAY, alignment=1, leading=9, spaceBefore=3,
    ))
