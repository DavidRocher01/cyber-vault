...
def generate_phishing_report(
    ...
    title_style = ParagraphStyle("ReportTitle", fontName="Helvetica-Bold", fontSize=22, textColor=_DARK, spaceAfter=4)
    subtitle_style = ParagraphStyle("Subtitle", fontName="Helvetica", fontSize=12, textColor=_GRAY, spaceAfter=10)
    section_style = ParagraphStyle("Section", fontName="Helvetica-Bold", fontSize=13, textColor=_DARK, spaceBefore=14, spaceAfter=6)
    body_style = ParagraphStyle("Body", fontName="Helvetica", fontSize=10, textColor=_DARK, spaceAfter=4)
    ...
    if len(dept_stats) > 1:
        ...
        dept_table = Table(dept_header + dept_rows, colWidths=[60 * mm, 22 * mm, 22 * mm, 35 * mm, 30 * mm])
