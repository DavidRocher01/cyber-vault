...
def generate_iso27001_pdf(
    ...
    summary_rows = [
        [
            ...
            Paragraph(
                "✓ Conf.",
                _st("H1", fontSize=8, fontName="Helvetica-Bold", textColor=GREEN),
            ),
            Paragraph(
                "~ Part.",
                _st("H2", fontSize=8, fontName="Helvetica-Bold", textColor=YELLOW),
            ),
            Paragraph(
                "✗ N.C.",
                _st("H3", fontSize=8, fontName="Helvetica-Bold", textColor=RED),
            ),
            Paragraph(
                "— N/A",
                _st("H4", fontSize=8, fontName="Helvetica-Bold", textColor=GRAY),
            ),
        ]
    ]
