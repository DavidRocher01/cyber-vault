"""
ISO 27001:2022 Compliance PDF report generator using ReportLab.
...
def generate_iso27001_pdf(
    ...
    right_content = [
        ...
        kpi_table,
        Spacer(1, 4),
        Paragraph(f"{total_items} contrôles évalués au total", total_st),
    ]
    ...
    # ── CATEGORY SUMMARY ────────────────────────────────────────────────────────
    story.append(Paragraph("Résumé par domaine", st["section"]))
    ...
    # ── DETAILED CHECKLIST ───────────────────────────────────────────────────────
    story.append(Paragraph("Détail des contrôles", st["section"]))
    story.append(section_rule(W, DOC_TYPE))
    ...
    story.append(Paragraph(
        ...
        "Ce rapport est fourni à titre indicatif et ne constitue pas une certification ISO 27001.",
