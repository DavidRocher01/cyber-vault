"""
runner.py — subprocess execution helpers and per-tool runner functions.

All runner functions accept a repo_dir (absolute path) and return a list of
normalised finding dicts:
  {tool, severity, rule, title, message, file, line, confidence, [fix_versions]}
"""
