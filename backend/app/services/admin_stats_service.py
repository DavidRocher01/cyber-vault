"""Service d'agregation des statistiques admin (dashboard global).

Regroupe tous les comptages et series temporelles du tableau de bord admin.
L'endpoint ne fait qu'appeler `compute_dashboard_stats` et renvoyer le dict.
"""
...
async def compute_dashboard_stats(db: AsyncSession) -> dict:
    """Calcule l'ensemble des statistiques du tableau de bord admin."""
