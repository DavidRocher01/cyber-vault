...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_phishing_campaigns_user_id"),
        "phishing_campaigns",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_phishing_targets_campaign_id"),
        "phishing_targets",
        ["campaign_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_phishing_domain_verifications_id"),
        "phishing_domain_verifications",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phishing_domain_verifications_user_id"),
        "phishing_domain_verifications",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_phishing_domain_verifications_domain"),
        "phishing_domain_verifications",
        ["domain"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_phishing_domain_verifications_domain"),
        table_name="phishing_domain_verifications",
    )
    op.drop_index(
        op.f("ix_phishing_domain_verifications_user_id"),
        table_name="phishing_domain_verifications",
