...
down_revision: str | tuple = ("e1f2a3b4c5d6", "f6a7b8c9d0e1")
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_url_scans_user_id_created_at",
        "url_scans",
        ["user_id", "created_at"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_code_scans_user_id_status",
        "code_scans",
        ["user_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_code_scans_user_id_created_at",
        "code_scans",
        ["user_id", "created_at"],
        unique=False,
    )
