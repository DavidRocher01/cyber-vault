...
def upgrade():
    ...
    op.add_column('rssi_clients', sa.Column(
    ...
    op.add_column('rssi_clients', sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True))

    op.add_column('users', sa.Column(
        'is_rssi_consultant', sa.Boolean(), nullable=False, server_default='false'
    ))
