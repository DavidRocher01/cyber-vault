...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('dossier_id', sa.Integer(),
                  sa.ForeignKey('darkweb_dossiers.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_index('ix_darkweb_dossier_targets_dossier_id', 'darkweb_dossier_targets', ['dossier_id'])
