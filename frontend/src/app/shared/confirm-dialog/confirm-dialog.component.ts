...
@Component({
  ...
  template: `
    <div
      class="bg-gray-900 rounded-2xl overflow-hidden w-full"
    ...
    >
      ...
      <div class="px-6 pt-6 pb-4 flex items-start gap-4">
        ...
        >
          <mat-icon
            class="!text-[1.3rem] !w-[1.3rem] !h-[1.3rem]"
      ...
      @if (data.danger) {
        <div
          class="mx-6 mb-4 flex items-center gap-2 bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-2.5"
        >
          <mat-icon class="text-red-400 !text-[1rem] !w-[1rem] !h-[1rem] flex-shrink-0"
            >warning</mat-icon
          >
