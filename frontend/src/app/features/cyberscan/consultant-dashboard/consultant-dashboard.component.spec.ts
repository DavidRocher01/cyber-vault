...
describe('ConsultantDashboardComponent — formulaLabel()', () => {
  it('retourne "Essentiel" pour essentiel', () => expect(make().formulaLabel('essentiel')).toBe('Essentiel'));
  it('retourne "Premium" pour premium', () => expect(make().formulaLabel('premium')).toBe('Premium'));
  it('retourne "Excellence" pour excellence', () => expect(make().formulaLabel('excellence')).toBe('Excellence'));
...
describe('ConsultantDashboardComponent — formulaClass()', () => {
  it('contient blue pour essentiel', () => expect(make().formulaClass('essentiel')).toContain('blue'));
  it('contient purple pour premium', () => expect(make().formulaClass('premium')).toContain('purple'));
  it('contient amber pour excellence', () => expect(make().formulaClass('excellence')).toContain('amber'));
...
describe('ConsultantDashboardComponent — clientStatusClass()', () => {
  it('contient green pour active', () => expect(make().clientStatusClass('active')).toContain('green'));
  it('contient yellow pour inactive', () => expect(make().clientStatusClass('inactive')).toContain('yellow'));
  it('contient red pour churned', () => expect(make().clientStatusClass('churned')).toContain('red'));
  it('retourne classe gray pour inconnu', () => expect(make().clientStatusClass('other')).toContain('gray'));
});
...
describe('ConsultantDashboardComponent — statusColor()', () => {
  ...
  it('contient yellow pour WARNING', () => expect(make().statusColor('WARNING')).toContain('yellow'));
...
describe('ConsultantDashboardComponent — alertSeverityClass()', () => {
  it('contient red pour critical', () => expect(make().alertSeverityClass('critical')).toContain('red'));
  it('contient orange pour high', () => expect(make().alertSeverityClass('high')).toContain('orange'));
  it('contient yellow pour medium', () => expect(make().alertSeverityClass('medium')).toContain('yellow'));
});

// ── alertIconColor ────────────────────────────────────────────────────────────

describe('ConsultantDashboardComponent — alertIconColor()', () => {
  it('contient red pour critical', () => expect(make().alertIconColor('critical')).toContain('red'));
  it('contient orange pour high', () => expect(make().alertIconColor('high')).toContain('orange'));
  it('contient yellow pour medium', () => expect(make().alertIconColor('medium')).toContain('yellow'));
});

// ── suggestionIcon ────────────────────────────────────────────────────────────

describe('ConsultantDashboardComponent — suggestionIcon()', () => {
  it('retourne trending_up pour upsell_opportunity', () => expect(make().suggestionIcon('upsell_opportunity')).toBe('trending_up'));
  it('retourne notification_important pour engagement_alert', () => expect(make().suggestionIcon('engagement_alert')).toBe('notification_important'));
  it('retourne event_available pour renewal_upcoming', () => expect(make().suggestionIcon('renewal_upcoming')).toBe('event_available'));
  it('retourne assignment_late pour high_overdue', () => expect(make().suggestionIcon('high_overdue')).toBe('assignment_late'));
  it('retourne lightbulb pour type inconnu', () => expect(make().suggestionIcon('other')).toBe('lightbulb'));
});
...
describe('ConsultantDashboardComponent — visitTypeLabel()', () => {
  ...
  it('retourne la valeur brute pour inconnu', () => expect(make().visitTypeLabel('other')).toBe('other'));
});
