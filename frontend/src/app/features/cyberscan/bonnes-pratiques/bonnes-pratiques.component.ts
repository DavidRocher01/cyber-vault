...
export class BonnesPratiquesComponent {
  ...
  constructor() {
    ...
    this.meta.updateTag({
      name: 'description',
      content:
        'Conseils pratiques pour renforcer votre sécurité : mots de passe, MFA, phishing, Wi-Fi public, sécurité physique. Accessibles à tous.',
    });
    this.meta.updateTag({
      property: 'og:title',
    ...
    this.meta.updateTag({
      ...
      content: 'Mots de passe, MFA, phishing, Wi-Fi — les fondamentaux de la cybersécurité.',
    });
    this.meta.updateTag({
      property: 'og:url',
      content: 'https://rochercybersecurite.com/bonnes-pratiques',
    });
    this.meta.updateTag({ property: 'og:type', content: 'website' });
    this._setCanonical('https://rochercybersecurite.com/bonnes-pratiques');
  }
  ...
  tableRows = [
    {
      risk: 'Accès',
      bad: '"123456" ou le même mot de passe partout',
      good: 'Un coffre-fort numérique (Bitwarden)',
    },
    {
      risk: 'Email',
      bad: 'Cliquer par peur ou par urgence',
      good: "Analyser l'expéditeur et survoler le lien",
    },
    {
      risk: 'Bureau',
      bad: 'Écran allumé pendant la pause café',
      good: 'Raccourci de verrouillage (Win+L)',
    },
    {
      risk: 'Wi-Fi public',
      bad: 'Connexion au Wi-Fi "Gare_Gratuit"',
      good: "Utilisation de la 4G/5G ou d'un VPN",
    },
    {
      risk: 'USB',
      bad: 'Brancher une clé trouvée par terre',
      good: 'Ne jamais connecter un périphérique inconnu',
    },
    {
      risk: 'Code source',
      bad: 'Token API hardcodé dans le dépôt Git',
      good: "Variable d'environnement + detect-secrets en CI",
    },
    {
      risk: 'Cloud IAM',
      bad: 'Compte admin avec droits wildcard (*)',
      good: 'Rôle IAM restreint au strict nécessaire',
    },
    {
      risk: 'S3 / Stockage',
      bad: 'Bucket public "par défaut"',
      good: 'Block Public Access activé + audit ACL régulier',
    },
    {
      risk: 'Patchs',
      bad: 'Mettre à jour "quand on a le temps"',
      good: 'Fenêtre de maintenance hebdomadaire + alertes CVE',
    },
    {
      risk: 'CI/CD',
      bad: 'Secrets en clair dans le fichier workflow',
      good: 'Vault CI chiffré + least privilege sur les tokens',
    },
  ];
}
