  ...
  template: `
    ...
    >
      ...
      <div class="absolute inset-0 pointer-events-none">
        ...
        <div
          class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full"
      ...
      <div class="relative flex items-center justify-center mb-8">
        <div
          class="absolute w-40 h-40 rounded-full border border-green-500/10 animate-ping"
          style="animation-duration:2.5s"
        ></div>
        <div
          class="absolute w-32 h-32 rounded-full border border-green-500/20 animate-ping"
          style="animation-duration:2s; animation-delay:0.3s"
        ></div>
        <div class="absolute w-24 h-24 rounded-full border border-green-500/30"></div>
        <div
          class="relative w-[4.5rem] h-[4.5rem] rounded-full flex items-center justify-center"
          style="background: rgba(74,222,128,0.12); border: 2px solid rgba(74,222,128,0.5); box-shadow: 0 0 32px rgba(74,222,128,0.15)"
        >
          <mat-icon class="text-green-400 !text-[2.2rem] !w-[2.2rem] !h-[2.2rem]"
      ...
      <!-- Plan card -->
      <div
        class="relative z-10 w-full max-w-xs mb-7"
