      ...
      <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:40px 24px;">
        <div style="max-width:480px;width:100%;text-align:center;">
          @if (status() === 'ok') {
            <!-- Success -->
            <div
              style="width:72px;height:72px;border-radius:50%;background:rgba(100,116,139,0.15);border:1px solid rgba(100,116,139,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;"
            >
              <mat-icon style="color:#94a3b8;font-size:32px;width:32px;height:32px;"
                >unsubscribe</mat-icon
              >
            </div>
            <p
              style="color:#67e8f9;font-size:12px;letter-spacing:2px;font-weight:600;margin:0 0 12px;text-transform:uppercase;"
            >
              Radar Cyber
            </p>
            ...
            <p style="color:#94a3b8;font-size:15px;line-height:1.7;margin:0 0 32px;">
              Vous avez bien été retiré(e) de la liste du Radar Cyber. Vous ne recevrez plus nos
              prochaines éditions.
            </p>

            <!-- Re-subscribe nudge -->
            <div
              style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:24px;margin-bottom:24px;"
            >
          ...
          @if (status() === 'invalid') {
            <!-- Invalid token -->
            <div
              style="width:72px;height:72px;border-radius:50%;background:rgba(239,68,68,0.12);border:1px solid rgba(239,68,68,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;"
            >
              <mat-icon style="color:#f87171;font-size:32px;width:32px;height:32px;"
