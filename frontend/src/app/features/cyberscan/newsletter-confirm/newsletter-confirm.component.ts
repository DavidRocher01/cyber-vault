      ...
      <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:40px 24px;">
        <div style="max-width:480px;width:100%;text-align:center;">
          @if (status() === 'ok') {
            <!-- Success -->
            <div
              style="width:72px;height:72px;border-radius:50%;background:rgba(34,197,94,0.12);border:1px solid rgba(34,197,94,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;"
            >
              <mat-icon style="color:#4ade80;font-size:32px;width:32px;height:32px;"
            ...
            <p style="color:#94a3b8;font-size:15px;line-height:1.7;margin:0 0 32px;">
              Bienvenue dans la communauté. Vous allez recevoir un email de bienvenue dans quelques
              instants. La prochaine édition du Radar Cyber arrive dans moins de deux semaines.
            </p>
...
export class NewsletterConfirmComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http
      .get(`${environment.apiUrl}/newsletter/confirm`, {
        params: { token },
        observe: 'response',
        responseType: 'text',
      })
