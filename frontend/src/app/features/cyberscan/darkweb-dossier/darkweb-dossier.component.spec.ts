...
describe('DarkwebDossierComponent — riskColor()', () => {
  ...
  it('text-yellow-400 si score entre 20 et 49', () => expect(make().riskColor(30)).toBe('text-yellow-400'));
...
describe('DarkwebDossierComponent — riskLabel()', () => {
  ...
  it('Risque modéré si score entre 20 et 49', () => expect(make().riskLabel(35)).toBe('Risque modéré'));
...
describe('DarkwebDossierComponent — statusLabel()', () => {
  ...
  it('Analyse en cours pour processing', () => expect(make().statusLabel('processing')).toBe('Analyse en cours'));
...
describe('DarkwebDossierComponent — statusColor()', () => {
  ...
  it('contient cyan pour processing', () => expect(make().statusColor('processing')).toContain('cyan'));
