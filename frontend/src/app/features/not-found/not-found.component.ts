...
@Component({
  ...
  template: `
    <div
      class="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center gap-6 text-center px-8"
    >
      <mat-icon class="!text-[6rem] !w-[6rem] !h-[6rem] text-cyan-400">gpp_bad</mat-icon>
      <h1
        class="text-8xl font-extrabold text-cyan-400"
      ...
      <div class="terminal-box" [class.expanded]="termOpen">
        <button class="term-toggle" (click)="termOpen = !termOpen; cdr.markForCheck()">
          <span
            style="font-family:'JetBrains Mono',monospace;font-size:0.75rem;color:#00e645;letter-spacing:0.1em"
          >
